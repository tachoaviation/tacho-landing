                ...
                <div>
                  ...
                  <div className="flex flex-col items-start" style={{ gap: '12px' }}>
                    <div className="flex flex-row items-center gap-3 text-gray-800">
                      ...
                      <a href="tel:+919645000747" className="hover:text-[#00488C] transition-colors" style={{ fontSize: '16px', textDecoration: 'none', color: 'inherit' }}>
                        Telephone - +91 9645000747
                      </a>
                    </div>
                    <div className="flex flex-row items-center gap-3 text-gray-800">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                      <a href="mailto:info@tachoaviation.com" className="hover:text-[#00488C] transition-colors" style={{ fontSize: '16px', textDecoration: 'none', color: 'inherit' }}>
