  ...
  return (
    <main className="min-h-screen bg-[#F2F6F9]">
      ...
      <div style={{ maxWidth: '1300px', margin: '0 auto', padding: '80px 48px', fontFamily: 'var(--font-poppins), Poppins, sans-serif' }}>
        ...
        <section id="value-protection" style={{ marginBottom: '120px', scrollMarginTop: '120px' }}>
          {/* Mobile layout (Figma-aligned) */}
          <div className="lg:hidden">
            <div className="approach-mobile-reveal">
              <p style={{ color: '#00488C', fontSize: '0.85rem', fontWeight: 700, letterSpacing: '0.05em', marginBottom: '12px', fontFamily: 'var(--font-geist-mono), monospace' }}>
                01 - Approach
              </p>
              <h2 style={{ fontSize: 'clamp(2rem, 9vw, 2.4rem)', color: '#111', fontWeight: 600, marginBottom: '14px', letterSpacing: '-0.01em', lineHeight: 1.12 }}>
                Value Protection
              </h2>
              <p style={{ color: '#545352', lineHeight: 1.55, fontSize: '1rem', fontWeight: 400 }}>
                We focus on preserving the long-term value of high-cost assets through lifecycle-driven technical management.
              </p>
            </div>

            <div className="approach-mobile-reveal approach-mobile-delay-1" style={{ marginTop: '24px', backgroundColor: '#D2F0FC', borderRadius: '16px', position: 'relative', minHeight: '340px', overflow: 'hidden' }}>
              <Image src="/a3.webp" alt="Value Protection" fill style={{ objectFit: 'contain', padding: '28px' }} />
            </div>

            <div className="approach-mobile-reveal approach-mobile-delay-2" style={{ marginTop: '12px', backgroundColor: '#D2F0FC', borderRadius: '12px', padding: '18px', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              ...
              <div>
                <h4 style={{ color: '#00488C', fontSize: '0.9rem', fontWeight: 600, marginBottom: '4px', fontFamily: 'var(--font-geist-mono), monospace' }}>Outcome</h4>
                <p style={{ color: '#111', fontSize: '0.8rem', lineHeight: '1.5' }}>
          ...
          <div className="hidden lg:flex lg:flex-row items-stretch justify-between gap-12 lg:gap-16">
        ...
        <section id="lessor-aligned-management" style={{ marginBottom: '120px', scrollMarginTop: '120px' }}>
          {/* Mobile layout (Figma-aligned) */}
          <div className="lg:hidden">
            <div className="approach-mobile-reveal">
              <p style={{ color: '#00488C', fontSize: '0.85rem', fontWeight: 700, letterSpacing: '0.05em', marginBottom: '12px', fontFamily: 'var(--font-geist-mono), monospace' }}>
            ...
            <div className="approach-mobile-reveal approach-mobile-delay-1" style={{ marginTop: '24px', backgroundColor: '#D2F0FC', borderRadius: '16px', position: 'relative', minHeight: '340px', overflow: 'hidden' }}>
              <Image src="/a1.webp" alt="Lessor-Aligned Management" fill style={{ objectFit: 'contain', padding: '28px' }} />
            </div>
          ...
          {/* Desktop layout (unchanged) */}
          <div className="hidden lg:flex lg:flex-row-reverse items-stretch justify-between gap-12 lg:gap-16">
            <div className="w-full lg:w-[46%]">
            <p style={{ color: '#00488C', fontSize: '0.85rem', fontWeight: 700, letterSpacing: '0.05em', marginBottom: '16px', fontFamily: 'var(--font-geist-mono), monospace' }}>
              02 - Approach
            </p>
        ...
        <section id="technical-oversight" style={{ marginBottom: '120px', scrollMarginTop: '120px' }}>
          {/* Mobile layout (Figma-aligned) */}
          <div className="lg:hidden">
            <div className="approach-mobile-reveal">
              <p style={{ color: '#00488C', fontSize: '0.85rem', fontWeight: 700, letterSpacing: '0.05em', marginBottom: '12px', fontFamily: 'var(--font-geist-mono), monospace' }}>
            ...
            <div className="approach-mobile-reveal approach-mobile-delay-1" style={{ marginTop: '24px', backgroundColor: '#D2F0FC', borderRadius: '16px', position: 'relative', minHeight: '340px', overflow: 'hidden' }}>
              <Image src="/a2.webp" alt="Technical Oversight" fill style={{ objectFit: 'contain', padding: '28px' }} />
            </div>
